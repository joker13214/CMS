...
protected:
	...
	bool     SaveDisplaceData(COneData_INFO* pData);										  //存储模拟量采集数据
	bool     SaveTemperaData(COneData_INFO* pData);											   //存储模拟量采集数据
	...
	bool	 Save_Alarm_Displace(COneData_INFO* pData);											//存储报警模拟量信息
	bool	 Save_Alarm_Tempera(COneData_INFO* pData);											//存储报警模拟量信息
protected:
	bool OpenDatabase();
