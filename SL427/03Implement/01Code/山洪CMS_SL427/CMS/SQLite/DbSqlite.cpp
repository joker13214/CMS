...
CDbSQLite::DirectStatement(LPCTSTR stmt)
{
	...
	sqlite_ex_result ret = pStatement->Execute();
	delete pStatement;
...
CDbSQLite::Begin()
{
   ...
   sqlite_ex_result ret = DirectStatement(m_szText);
   return ret.blResult;
}
