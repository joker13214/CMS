...
protected:
    ...
    CRtuAttrTextMsg*   m_pTabAttrTextMsg;
...
public:
	...
	CRtuAttrTextMsg*        GetTab_AttrTextMsg()    {return m_pTabAttrTextMsg;}

	CRtuAttrWorkMode*		GetTab_AttrWorkMode();	
	CRtuAttrAutoRpSet*		GetTab_AttrAutoRpSet();	
	CRtuAttrAlertAnalog*    GetTab_AttrAlertAnalog();
	CRtuAttrDisplacement*   GetTab_AttrDisplacement();
	CRtuAttrTemperature*   	GetTab_AttrTemperature();
