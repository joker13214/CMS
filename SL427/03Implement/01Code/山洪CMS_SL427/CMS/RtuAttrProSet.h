...
protected:
	...
	CRtuAttrDisplacement* m_pTabAttrDisplacement;                               //位移量
	CRtuAttrTemperature* m_pTabAttrTemperature;									//温度量
...
public:
	...
	CRtuAttrDisplacement*	GetTab_AttrDisplacement()		{return m_pTabAttrDisplacement;}
	CRtuAttrTemperature*	GetTab_AttrTemperature()		{return m_pTabAttrTemperature;}
