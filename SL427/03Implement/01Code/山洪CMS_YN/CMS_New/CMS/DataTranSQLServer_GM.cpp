...
//bool CDataTranSQLServer_GM::SaveWaterLevelData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
...
//	{
//		blResult = false;
//		strMessage.Format("存储水位数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		AddThreadLog(strMessage,_LevelType);
//	}
//
//	return blResult;
//}
//
//bool CDataTranSQLServer_GM::SaveWaterPressData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储水压数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//		
//		//AddLogMessage(DATAIN_ERROR_LOG,strMessage,Error_Log_message);
//		AddThreadLog(strMessage,_LevelType);
//	}
//
//	return blResult;
//}
//
//bool CDataTranSQLServer_GM::SaveWaterQualityData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储水质数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		//AddOneMessage(strMessage,(PSYSTEMTIME)NULL,_levelType);
//		//AddLogMessage(DATAIN_ERROR_LOG,strMessage,Error_Log_message);
//		AddThreadLog(strMessage,_LevelType);
//	}
//
...
//}
//
//bool CDataTranSQLServer_GM::SaveWaterFlowData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储流量/取水量数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		//AddOneMessage(strMessage,(PSYSTEMTIME)NULL,_levelType);
...
//}
//
//bool CDataTranSQLServer_GM::SaveRainData( COneData_INFO* pData, CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储雨量数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		AddThreadLog(strMessage,_LevelType);
...
//}
//
//bool CDataTranSQLServer_GM::SaveOperateRecord( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储操作记录数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		AddThreadLog(strMessage,_LevelType);
...
//}
//
//bool CDataTranSQLServer_GM::SaveAnalogData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储模拟量相关数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		AddThreadLog(strMessage,_LevelType);
...
//}
//
//bool CDataTranSQLServer_GM::SavePulseData( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL="";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult= false;
//		strMessage.Format("存储电度量相关数据失败,Error:%s",pe->m_strError);
//		_LevelType = Error_Log_message;
//		pe->Delete();
//
//		AddThreadLog(strMessage,_LevelType);
...
//}
//
//bool CDataTranSQLServer_GM::SaveAlarmRecord( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//			blResult = false;
//			_LevelType = Error_Log_message;
//			strMessage.Format("存储报警数据,Error:%s",pe->m_strError);
//			pe->Delete();
//			AddThreadLog(strMessage,_LevelType);
//		}
//
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_WaterLevel( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage = "";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警水位信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//		AddThreadLog(strMessage,_LevelType);
//	}
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_WaterPress( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage ="";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警水压信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//		AddThreadLog(strMessage,_LevelType);
//	}
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_WaterQuality( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage ="";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警水质信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//		AddThreadLog(strMessage,_LevelType);
//	}
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_Flow( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage ="";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警取水量流量信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//		AddThreadLog(strMessage,_LevelType);
//	}
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_Rain( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage ="";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警雨量信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//		AddThreadLog(strMessage,_LevelType);
//	}
...
//}
//
//bool CDataTranSQLServer_GM::Save_Alarm_Analog( COneData_INFO* pData,CDatabase* pDb )
//{
//	CString strMessage ="";
//	CString strSQL = "";
//	_Log_level_type _LevelType = Normal_Log_Message;
...
//	{
//		blResult = false;
//		strMessage.Format("存储报警模拟量信息,Error:%s",pe->m_strError);
//		pe->Delete();
//		_LevelType = Error_Log_message;
//
//		AddThreadLog(strMessage,_LevelType);
