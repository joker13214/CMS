...
class CRtuAttrHydrInfoQuery : public CDialog
{
	DECLARE_DYNAMIC(CRtuAttrHydrInfoQuery)

public:
	CRtuAttrHydrInfoQuery(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CRtuAttrHydrInfoQuery();

// 对话框数据
	enum { IDD = IDD_RTU_QUERY_HYDRINFO };
